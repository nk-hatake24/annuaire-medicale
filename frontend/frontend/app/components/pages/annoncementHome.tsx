  ...
  return (
    <section className="announcementHomePage  lg:h-screen flex-row flex  bg-slate-200">
      <div className="lg:w-1/2 w-full h-screen flex flex-col gap-8 justify-center px-4 lg:pl-28 md:pr-8">
        <h2 className="text-3xl tracking-tight font-bold self-center">Share Announcement</h2> 
        ...
        <button className="p-2 text-gray-50 bg-blue-600 hover:bg-transparent border self-center border-blue-600 hover:text-blue-600  font-semibold max-w-80 rounded-sm">view latest  announcements.</button>
